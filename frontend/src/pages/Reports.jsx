      ...
      <main className="dashboard reports-page">
        ...
        <div className="reports-content">
          ...
          <section className="reports-card">
            ...
            <div className="reports-card-header">
              <div>
                ...
                <p>Recent satellite analysis reports</p>
              </div>
                ...
                <div className="report-row" key={report.id}>
                  ...
                  <div className="report-name">
                    ...
                    <div>
                      ...
                      <small>Report #{String(report.id).padStart(3, "0")}</small>
                    </div>
                  </div>
                  ...
                  <div className="report-actions">
                    ...
                    <button
                      ...
                      onClick={() =>
                        alert("Demo: report download will be connected later.")
                      }
                    >
                      <Download size={16} />
                    </button>
          ...
          <section className="reports-cta">
            ...
            <div>
              <h3>Create a detailed satellite report</h3>
              <p>
